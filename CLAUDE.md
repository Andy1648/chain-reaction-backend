...
- Game modes: `gameLogic.js` (Word Bomb), `categoryBlitzLogic.js`; bots in `wordBombBot.js` / `categoryBlitzBot.js`. (Imposter Word was removed 2026-08; T5 experimental modes live in `t5*Mode.js` via `t5Modes.js`.)
